...
def init_opengl(width, height):
    ...
    glLoadIdentity()
    gluPerspective(45, (width / height), 1, 1000.0)
...
def main():
    ...
    fullscreen = True  # Cambiar a False para modo ventana
    ...
    while running:
        ...
        # Empezar a dibujar en 3D
        glLoadIdentity()
        gluLookAt(0, -500, 200, 0, 0, 0, 0, 0, 1)
        ...
        # Actualizar pantalla
        pygame.display.flip()
        clock.tick(165)  # Limitar a 165 FPS
